...
public class Admin_Login_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnsignin.setFont(new java.awt.Font("Calibri", 0, 15)); // NOI18N
    ...
    private void btnsigninActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsigninActionPerformed
        ...
        String sql = "select * from admin_info where Username='"+Username+"' and Password='"+password+"'";
        ResultSet rs = stm.executeQuery(sql);
        if(rs.next()){
           dispose();
            JOptionPane.showMessageDialog(this, "Successful");
            Admin_Home_Page hpage =new Admin_Home_Page();
            hpage.show();
        } else {
